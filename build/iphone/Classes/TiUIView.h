...
/**
 Base class for all ForestApp views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the ForestApp view hierarchy (such as wrapped iOS UIViews) was touched.
