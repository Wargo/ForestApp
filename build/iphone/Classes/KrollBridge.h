...
@interface ForestAppObject : KrollCoverageObject {
#else
@interface ForestAppObject : KrollObject {
#endif
@private
...
extern NSString * ForestApp$ModuleRequireFormat;
