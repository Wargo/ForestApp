...
// in simulator we redefine to format for ForestApp Developer console
...
{\
	NSString * exceptionName = [@"org.forestapp." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.forestapp";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UIForestAppNativeItemNone = -1, 
	UIForestAppNativeItemSpinner = -2,
	UIForestAppNativeItemProgressBar = -3,
	
	UIForestAppNativeItemSlider = -4,
	UIForestAppNativeItemSwitch = -5,
	UIForestAppNativeItemMultiButton = -6,
	UIForestAppNativeItemSegmented = -7,
	
	UIForestAppNativeItemTextView = -8,
	UIForestAppNativeItemTextField = -9,
	UIForestAppNativeItemSearchBar = -10,
	
	UIForestAppNativeItemPicker = -11,
	UIForestAppNativeItemDatePicker = -12,
	
	UIForestAppNativeItemInfoLight = -13,
	UIForestAppNativeItemInfoDark = -14,
	
	UIForestAppNativeItemDisclosure = -15,
	
	UIForestAppNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all ForestApp instances of
