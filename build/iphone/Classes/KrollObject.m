 ...
 * Copyright (c) 2009-2011 by ForestApp, Inc. All Rights Reserved.
...
//@interface ForestAppObject : NSObject
//@end

@interface ForestAppObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[ForestAppObject class]])
		{
			for (NSString *key in [[(ForestAppObject*)o modules] allKeys])
			{
